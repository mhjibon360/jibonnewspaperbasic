                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-4">Create New Category</h4>
                            ...
                            <form method="POST" action="{{ route('category.store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="category_name_en" name="category_name_en"
                                               ...
                                               is-invalid
                                            @enderror"
                                                value="{{ old('category_name_en') }}" placeholder="english">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="category_name_bn" name="category_name_bn"
                                                ...
                                                is-invalid
                                             @enderror"
                                                value="{{ old('category_name_bn') }}" placeholder="bangla">
                                    ...
                                    <div class="form-group">
                                      <button type="submit" class=" btn btn-success waves-effect waves-light">Create Category</button>
                                    </div>
                                </div>
                            </form>
                        </div> <!-- end card-body -->
