                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allvideo as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('videogallery.edit', $item->id) }}" title="edit news"
                                                    ...
                                                    @if ($item->status == '1')
                                                        <a href="{{ route('videogallery.show', $item->id) }}"
                                                            title="inactive news"
                                                    ...
                                                    <form action="{{ route('videogallery.destroy', $item->id) }}"
