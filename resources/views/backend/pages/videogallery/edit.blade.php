...
@section('title', 'edit video in gallery')
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-4">Edit video galllery post</h4>

                            <form method="POST" action="{{ route('videogallery.update', $gallery->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        is-invalid
                                      @enderror"
                                                id="title_en" name="title_en" value="{{ $gallery->title_en }}">
                                            @error('title_en')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        is-invalid
                                      @enderror"
                                                id="title_bn" name="title_bn" value="{{ $gallery->title_bn }}">
                                            @error('title_bn')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        is-invalid
                                      @enderror"
                                                id="link" name="link" value="{{ $gallery->link }}">
                                            @error('link')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class=" new-image-design shadow"
                                            ...
                                            <img src="{{ asset($gallery->image) }}" id="img_show" class=" img-fluid img_show" alt="">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <button type="submit" class=" btn btn-success waves-effect waves-light">Update Video
                                        Gallery</button>
                                </div>
                            </form>
                        </div> <!-- end card-body -->
