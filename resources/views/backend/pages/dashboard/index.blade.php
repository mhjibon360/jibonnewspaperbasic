                      ...
                      <ol class="breadcrumb m-0">
                        ...
                        <h4 class="page-title">Dashboard &nbsp;&nbsp;
                            ...
                            @if (Auth::user()->status == 'active')
                                <span class=" text-success"> <i class=" fas fa-circle" style="font-size: 8px;"></i> Active</span>
                            @else
                                <span class=" text-danger mb-0">InActive</span>
                                <br>
                                <span class=" text-danger">please Wait admin check and active your account</span>
                            @endif
                        </h4>
                    </div>
                </div>
