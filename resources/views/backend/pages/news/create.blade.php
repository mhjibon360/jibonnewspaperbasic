                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('news.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="title_en" name="title_en"
                                               ...
                                               is-invalid
                                            @enderror"
                                                value="{{ old('title_en') }}" placeholder="english">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="title_bn" name="title_bn"
                                                ...
                                                is-invalid
                                             @enderror"
                                                value="{{ old('title_bn') }}" placeholder="bangla">
                                            @error('title_bn')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                              ...
                                              is-invalid
                                            @enderror"
                                                id="tags_en" name="tags_en" value="" data-role="tagsinput">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                              ...
                                              is-invalid
                                            @enderror"
                                                id="tags_bn" name="tags_bn" value="" data-role="tagsinput">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="image" class="form-label">News Details
                                                Thumbnail</label>
                                            <input type="file"
                                    ...
                                    <div class="col-lg-6">
                                        <div class=" new-image-design shadow p-1"
                                            ...
                                            <img src="{{ asset('upload/no_image.jpg') }}" id="img_show"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-check mb-2 form-check-pink">
                                            <input class="form-check-input" name="show_at_breaking" type="checkbox"
                                                value="1" id="show_at_breaking">
                                            <label class="form-check-label" for="show_at_breaking">Show At Breaking</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input class="form-check-input" name="show_at_slider" type="checkbox"
                                                value="1" id="show_at_slider">
