...
@section('title', 'create photo in gallery')
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-4">Create New Photo in galllery</h4>

                            <form method="POST" action="{{ route('photogallery.store') }}" enctype="multipart/form-data">
                                @csrf
