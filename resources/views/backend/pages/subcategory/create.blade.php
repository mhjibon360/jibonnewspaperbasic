...
@section('title', 'create new subcategory dashboard')
@section('content')
@push('style-file')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-4">Create New SubCategory</h4>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="subcategory_name_en" name="subcategory_name_en"
                                               ...
                                               is-invalid
                                            @enderror"
                                                value="{{ old('subcategory_name_en') }}" placeholder="english">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="subcategory_name_bn" name="subcategory_name_bn"
                                                ...
                                                is-invalid
                                             @enderror"
                                                value="{{ old('subcategory_name_bn') }}" placeholder="bangla">
