...
@section('title', 'edit admin accounts')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('show.all.admin.account') }}"
                                ...
                                <i class="mdi mdi-format-list-bulleted-square"></i>All Admin-Account
                            </a>
                            <h4 class="header-title mb-4">Edit Admin-Accountt</h4>

                            <form method="POST" action="{{ route('update.admin.account', $admin->id) }}"
                                         ...
                                         @enderror"
                                                ...
                                                @foreach ($allrole as $role)
                                                    <option value="{{ $role->name }}"
                                                        {{ $admin->hasrole($role->id) ? 'selected' : '' }}>{{ $role->name }}
                                                    </option>
                                                @endforeach
                                            </select>
