...
<head>
    ...
    <title>jibonbd News | @yield('title') </title>
    <script type="text/javascript"
        src="https://platform-api.sharethis.com/js/sharethis.js#property=660165c236e2d3001920094a&product=inline-share-buttons&source=platform"
        async="async"></script>
...
<body class="home blog" oncontextmenu="return true" data-new-gr-c-s-check-loaded="14.1078.0" data-gr-ext-installed="">
    ...
    <div class="main_website">
        ...
        @include('frontend.layouts.inc.header-menu')

        @include('frontend.layouts.inc.breaking-new')
